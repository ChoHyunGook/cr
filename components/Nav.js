...
const basicSettings = {
    subTitles: [
    "게시판 글쓰기","게시판 리스트",'게시글 수정','게시글 삭제','악보표출','악보등록','링크','프로필'
    ],
    urls: ["/board/write", "/board/list", '/board/update','/board/remove','basic/analysis','basic/analysisSelect','basic/link','basic/profile']
  };
